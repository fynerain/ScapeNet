# ScapeNet
A small library built on Lidgren for sending larger amounts of data. With Unity support for video game networking, gearedfor a more low level approach in the wake of UNET's demise.
